...
# HTMLファイルを書き込み
with open('gcmc_link_visualizer_standalone.html', 'w', encoding='utf-8') as f:
    f.write(html_template)

print("✓ HTMLファイルを生成しました: gcmc_link_visualizer_standalone.html")
