...
# 広告ドメインのパターン（よくあるアフィリエイト・広告プラットフォーム）
AD_DOMAINS = [
...
class GCMCLinkAnalyzer:
    def __init__(self, csv_path):
        self.csv_path = csv_path
        self.pages_data = []
        self.domain = 'gcm.clinic'
...
def main():
    csv_path = '/Users/rk/Library/CloudStorage/Dropbox/Fundit/gcmc_urls_with_keywords.csv'
    output_path = '/Users/rk/Library/CloudStorage/Dropbox/Fundit/gcmc_link_analysis_report.json'
    
    analyzer = GCMCLinkAnalyzer(csv_path)
    analyzer.analyze()
